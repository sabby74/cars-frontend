  ...
  return services.map((service) => {
    return (
      <div key={service._id} className="services">
        ...
        <h2>Transmission Oil Change : {service.transmissionOilChange ? "yes" : "No"}</h2>
        <h2>Cabin Air Filter Change : {service.cabinAirFilterChange ? "yes" : "No"}</h2>
        <h2>Engine Air Filter Change : {service.engineAirFilter ? "yes" : "No"}</h2>
        <h2>Wiper Blades Change : {service.wiperBladesChange ? "yes" : "No"}</h2>
